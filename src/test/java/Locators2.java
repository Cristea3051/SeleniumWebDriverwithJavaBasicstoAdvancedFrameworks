...
public class Locators2 {
    ...
    public static void main(String[] args) throws InterruptedException  {
        ...
        Assert.assertEquals(driver.findElement(By.cssSelector("div[class='login-container'] h2")).getText(), "Hello Mos Vij,");

        // Aceasta este metoda pentru a gasi locatorul care are in el un text caracteristic pentru button,
        // Deci asa gasim un button dupa mesajul care este in el, important este ca textul trebuie luat din DOM
    ...
    public static String getPassword(WebDriver driver)throws InterruptedException {
        ...
        // Aceasta este metoda cu care extrag un cuvant dintr-un sintring separat. Treb de vazut si de facut s-o inteleg ca lumea
