...
public class SelectDropDown {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.id("ctl00_mainContent_rbtnl_Trip_1")).click();
        System.out
                .println(driver.findElement(By.name("ctl00$mainContent$view_date2")).isEnabled() + " asta la calendar");
        ...
        // Assert false in testng, va compara daca nu este selectat cheboxul va da false
        // si va fi egal cu asertul din test ng ceea ce va face ca testul sa fie passed
        Assert.assertFalse(driver.findElement(By.cssSelector("input[id*='SeniorCitizenDiscount']")).isSelected());
        Assert.assertFalse(false);
        // Va printa in colosla true sau false in dependenta daca este sau nu apasat
        // acel checkbox
