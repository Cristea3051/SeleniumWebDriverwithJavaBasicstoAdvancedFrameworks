...
public class HandleCalendar {
    ...
    public static void main(String[] args) throws InterruptedException{
       ...
       WebElement yearCalendar =  driver.findElement(By.cssSelector("button[class ='react-calendar__navigation__label']"));
      ...
      List<WebElement> monthElements = driver.findElements(By.cssSelector("button[class='react-calendar__tile react-calendar__year-view__months__month']"));
